...
import AllUsersPage from "./components/pages/user/AllUserPage";
import AddCustomerPage from "./components/pages/customer/AddCustomerPage";
import EditCustomerPage from "./components/pages/customer/EditCustomerPage";
import AllCustomersPage from "./components/pages/customer/AllCustomersPage";
